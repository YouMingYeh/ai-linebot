...
const stickerEventHandler = async (event, user, clientApi, repo) => {
    ...
    try {
        ...
        await clientApi.replyTextMessage(event.replyToken, "抱歉，我在處理您的貼圖時遇到了問題。請稍後再試。");
    }
};
export default stickerEventHandler;
//# sourceMappingURL=sticker-event-handler.js.map