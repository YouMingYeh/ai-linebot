...
const videoEventHandler = async (event, user, clientApi, repo) => {
    ...
    try {
        ...
        await clientApi.replyTextMessage(event.replyToken, "抱歉，我在處理您的影片時遇到了問題。請稍後再試。");
    }
};
export default videoEventHandler;
//# sourceMappingURL=video-event-handler.js.map